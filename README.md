...
[![Version](https://img.shields.io/badge/version-2.0.0.1-blue.svg?style=for-the-badge)](#)
...
sequenceDiagram
    ...
    User->>GitHub: Browse to /skills/ folder
    GitHub-->>User: Copy raw content of desired skill (e.g., ml_engineer.json)
    User->>Extension: Paste JSON into Custom Prompt Field
    Extension->>Extension: Parse Voice Rules & Anti-Patterns
    Extension->>AI: Inject Persona Context
    Note over AI: AI now thinks and types<br/>like a Pragmatic ML Engineer
```
...
```mermaid
graph TD;
    A[User Clicks Start] --> B[Scanner Module];
    B -->|Finds Relevant Post| C[Extracts Context];
    C --> D[AI Core];
    D -->|Applies Custom JSON Skill/Persona| E[Generates Comment];
    E -->|Human-like Delay| F[Injector Module];
    F -->|Types & Submits| G[Post Engaged!];
    G -->|Cooldown Timer| B;
```
...
<a href="https://github.com/Faizan-Khanx/AI-Commenter-for-LinkedIn/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=Faizan-Khanx/AI-Commenter-for-LinkedIn" alt="Contributors Graph" />
</a>
...
<div align="center">
<br/>
<b>Developed with ❤️ by CyberEthic</b><br>
